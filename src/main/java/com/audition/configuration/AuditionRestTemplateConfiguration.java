...
@Configuration
public class AuditionRestTemplateConfiguration {

    @Bean
    public RestTemplate auditionRestTemplate(RestTemplateBuilder builder,
        ClientHttpRequestFactory clientHttpRequestFactory,
        @Value("${audition-source-url}") String auditionSourceUrl) {
        return builder
